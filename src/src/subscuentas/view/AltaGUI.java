    ...
    public void initGUI() {
        ...
        alta.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    if(titularText.getText().equals("") || dniText.getText().equals("") || firma_digitalText.getText().equals("")) throw new GUIException("Alguno de los valores obligatorios esta vacío");

                    IFachadaSubsCuentas subsCuentas = new FachadaSubsCuentas();
                    int resultado = 1; 
                    if(movimientosText.getText().equals("") && saldoText.getText().equals("0")) {
                        resultado = subsCuentas.altaCuenta(new Cuenta(titularText.getText(),dniText.getText(),Integer.parseInt(num_cuentaText.getText()),0,firma_digitalText.getText(),new JSONArray())); 
                    } else {
                        JSONArray movimientosArray = new JSONArray(); 
                        movimientosArray.put(movimientosText.getText()); 
                        resultado = subsCuentas.altaCuenta(new Cuenta(titularText.getText(),dniText.getText(),Integer.parseInt(num_cuentaText.getText()),Double.parseDouble(saldoText.getText()),firma_digitalText.getText(),movimientosArray)); 
                    }
